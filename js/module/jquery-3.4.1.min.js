...
jsPath = jsPath.substring(0,jsPath.indexOf("GYL")+3);
//动态导入js 或者css


$.includePath = "http://"+window.location.host + "/";

$.include([
    "public/dist/css/layui.css",
    "public/font/iconfont.css",
    "css/twocss/commit.css",
