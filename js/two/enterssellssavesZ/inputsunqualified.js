        ...
        window.location.reload();
           ...
           //监听头部监听
            table.on('toolbar(testdome)', function(obj) {
                ...
                switch (obj.event) {
                    case 'add':
                            window.location.href = "./dialog/addInputsunqualified.html";
                        break;
                    case 'update':
                        if(data.length === 0){
                            layer.msg('请选择一行');
                            ...
                            window.location.href = "./dialog/addInputsunqualified.html?id="+data[0].id;
                        }
                        break;
                    case 'delete':
                        if (data.length === 0) {
          ...
          function getList(){
            ...
            var tableIns = table.render({
                elem: "#test",
                url: baseaip + "plant/StockSellSaveManage/getPlantHandles",
                method: "GET",
                where: {
                    startDate: startDate,
                    endDate: endDate,
