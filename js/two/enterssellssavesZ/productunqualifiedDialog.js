(function() {
    layui.use(['upload', 'form', 'element', 'table', "layer", "laydate", "util"], function() {
        ...
        function uploadImg(){
            ...
            Theoldcuiway(
                "plant/StockSellSaveManage/saveBelowStandard", {
                    expectno:$('#expectno').val(),
                    chargeperson:$('#chargeperson').val(),
                    measure:$('#measure').val(),
                    measureaddr:$('#measureaddr').val(),
                    weight:$('#weight').val(),
        ...
        getList();
          function getList(){
            ...
            var tableIns = table.render({
                elem: "#test",
                url: baseaip + "plant/StockSellSaveManage/getStockFruitBatchList",
                method: "GET",
                where: {
