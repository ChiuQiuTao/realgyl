                ...
                landName:'' },
                 "GET").done(function(resp) {
                    ...
                    for(var i=0;i<resp.data.content.length;i++){
                        landnameP.innerHTML = landnameP.innerHTML+'<option value="'+resp.data.content[i].id+'" class="persontypeitem">'+resp.data.content[i].landname+'</option>'
                    }
                    layui.form.render();
                    return
                }).fail(function(err) {
