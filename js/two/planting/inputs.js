        ...
        window.location.reload();
            ...
            table.on('toolbar(testdome)', function(obj) {
                ...
                switch (obj.event) {
                    case 'add':
                            ...
                            window.location.href = "./newpage/newinputs.html";
                    ...
                    case 'update':
                        if(data.length === 0){
                            ...
                            window.location.href = "./newpage/newinputs.html?id="+data[0].id;
                        }
                        break;
                    case 'delete':
                        if (data.length === 0) {
          ...
          function getList(){
            ...
            var tableIns = table.render({
                elem: "#test",
                url: baseaip + "plant/PlantManage/getPlantInputProducts",
                method: "GET",
                where: {
                    startDate: startDate,
                    endDate: endDate,
